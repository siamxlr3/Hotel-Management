...
# This runs storage:link at container start (AFTER the persistent disk is mounted)
...
# At startup: re-create symlink (disk is now mounted), fix permissions, then start Apache
